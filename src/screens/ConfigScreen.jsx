        ...
        <div className="tab-content on">
          <div className="card">
            ...
            <div className="stat-row">
              ...
              <span className="stat-val" style={{ color: 'var(--green)' }}>100%</span>
            </div>
            <div className="stat-row">
            ...
            <div className="callout teal" style={{ marginTop: '12px' }}>
        ...
        <div className="tab-content on">
          <div className="card">
            ...
            <div className="stat-row">
              ...
              <span className="stat-val">Email · Patient's chosen time</span>
            </div>
            <div className="stat-row">
              <span className="stat-label">Weekly report delivery</span>
              <span className="stat-val">Email + In-platform · Every 7 days</span>
            </div>
            <div className="stat-row">
              <span className="stat-label">Advocacy doc ready</span>
              <span className="stat-val">Email + In-platform · On approval</span>
            </div>
            <div className="stat-row">
              <span className="stat-label">Amber flag to clinic</span>
              <span className="stat-val">Email · After Allvi clinical review</span>
            </div>
            <div className="stat-row">
              <span className="stat-label">Red flag to clinic</span>
              <span className="stat-val">Email · Immediate after review</span>
            </div>
            <div className="stat-row">
              <span className="stat-label">Pre-appointment summary to clinician</span>
              <span className="stat-val">Email PDF · 5 days before appointment</span>
            </div>
            <div className="stat-row">
              <span className="stat-label">Advocacy doc trigger</span>
              <span className="stat-val">7 days before appointment date</span>
            </div>

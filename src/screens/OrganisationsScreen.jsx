...
const OrganisationsScreen = () => {
  ...
  return (
    <div style={{ animation: 'fadeIn 0.15s ease-in-out' }}>
      ...
      {/* PH HEADER */}
      <div className="ph" style={{ flexWrap: 'wrap', gap: '14px', marginBottom: '24px' }}>
        <div>
          ...
          <tbody>
            {organisations.map((org) => (
              ...
              >
                <td>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '11px', color: 'var(--grey)' }}>{org.id ? `${org.id.substring(0, 8)}...` : 'UUID'}</div>
                    </div>
                  </div>
                </td>
                ...
                <td style={{ fontSize: '12px', whiteSpace: 'nowrap' }}>£99/patient/mo<br/><span style={{ color: 'var(--grey)' }}>30% rev share</span></td>
                <td><span className="badge green">✓ Signed</span></td>
                <td><span className="badge grey">N/A</span></td>
                <td style={{ fontSize: '12px', color: 'var(--grey)', whiteSpace: 'nowrap' }}>31 Dec 2026</td>
      ...
      {selectedOrg && (
        <div className="card">
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '25px', flexWrap: 'wrap', gap: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
              <div style={{ width: '64px', height: '64px', borderRadius: '12px', background: 'var(--teal)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Playfair Display', serif", fontSize: '24px', color: 'var(--ivory)', flexShrink: 0 }}>
          ...
          <div className="tab-content on">
            ...
            {activeSubTab === 'branding' && (
              <div>
                <p style={{ fontSize: '13px', color: 'var(--grey)', marginBottom: '20px', lineHeight: '1.5' }}>
                ...
                <div className="form-row-2">
                  <div className="form-row">
                    ...
                    <div className="logo-upload" style={{ minHeight: '140px', padding: '20px' }}>
                      <div className="logo-preview">{selectedOrg.name?.charAt(0).toUpperCase()}</div>
                      <div style={{ fontSize: '14px', fontWeight: 500, color: 'var(--teal)', cursor: 'pointer' }}>Click to upload new logo</div>
                      <div style={{ fontSize: '12px', color: 'var(--grey)', marginTop: '4px', maxWidth: '280px', textAlign: 'center' }}>PNG or SVG · max 2MB · recommended 200×200px</div>
                    </div>
                  </div>
                  <div>
                ...
                <button className="btn btn-primary" style={{ marginTop: '12px' }}>Save Branding</button>
              </div>
            )}
            ...
            {activeSubTab === 'members' && (
              <div>
                ...
                <button className="btn btn-ghost btn-sm" style={{ marginTop: '8px' }}>+ Invite Team Member</button>
              </div>
            )}
